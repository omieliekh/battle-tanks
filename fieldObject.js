Tanks.FieldObject = atom.Class({
	...
	addToGridArr : function(shift){
		...
		// проверка чтоб будущее положение объекта не выходило за границы поля
	...
	rmFromGridArr : function (){
		if (null != this.workArr) {		
			...
			for (q=0; q<this.workArr.length; q++){				
				...
				//this.workArr[q] - координаты клетки поля, хранятся, чтобы объект знал где находится
			}
		}		
	},
